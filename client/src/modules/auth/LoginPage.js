...
//         </div>
//       )}
//       <div className="w-full h-[45%] bg-[url('https://images.unsplash.com/photo-1600891964599-f61ba0e24092')] bg-cover bg-top bg-no-repeat flex items-center justify-center">
//         <img
...
//         <h2 className="text-[50px] text-white text-center pb-[10px]">
//           INICIAR SESIÓN
//         </h2>
