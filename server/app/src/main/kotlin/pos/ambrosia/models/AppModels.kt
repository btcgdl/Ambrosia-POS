...
@Serializable data class RolePassword(val password: String)
...
@Serializable data class RolePermissionsUpdateRequest(val permissions: List<String>)

@Serializable data class RolePermissionsUpdateResult(val roleId: String, val assigned: Int)
...
@Serializable data class SetPrinterRequest(val type: TicketType, val printerName: String)
...
@Serializable data class CategoryItem(val id: String? = null, val name: String)

@Serializable data class CategoryUpsert(val name: String, val type: String? = null)
