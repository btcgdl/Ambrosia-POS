...
class TableService(private val connection: Connection) {
    companion object {
        ...
        private const val CHECK_SPACE_EXISTS =
                "SELECT id FROM spaces WHERE id = ? AND is_deleted = 0"
    ...
    private fun tableNameExistsInSpace(tableName: String, spaceId: String): Boolean {
